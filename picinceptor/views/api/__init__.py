...
class ObservationResource(Resource):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('observationDate', dest='observation_date',
                                 type=_parse_json_date, required=True, nullable=False,
                                 help='Observation date')
        self.parser.add_argument('woodpeckerId', dest='woodpecker', type=int, required=True,
                                 nullable=False, help='TAXREF id of the woodpecker')
        self.parser.add_argument('nestingIndex', dest='breeding_code', type=int, required=True,
                                 nullable=False, help='Woodpecker breeding code')
        self.parser.add_argument('habitat', type=str, required=True, nullable=False,
                                 help='Habitat where woodpecker has been seen')
        self.parser.add_argument('dominant', dest='dominant_tree', type=str, required=False,
                                 help='Dominant tree in the forest where woodpecker has been seen')
        self.parser.add_argument('hasDeadTrees', dest='has_dead_trees', type=bool, required=False,
                                 help=('Are there any dead trees in the forest where woodpecker '
                                       'has been seen'))
        self.parser.add_argument('hasConifer', dest='has_conifers', type=bool, required=False,
                                 help=('Are there any conifers in the forest where woodpecker '
                                       'has been seen'))
        self.parser.add_argument('firstName', dest='observer_first_name', type=str, required=True,
                                 nullable=False, help='Observer first name')
        self.parser.add_argument('surname', dest='observer_surname', type=str, required=True,
                                 nullable=False, help='Observer surname')
        self.parser.add_argument('email', dest='observer_email', type=str, required=True,
